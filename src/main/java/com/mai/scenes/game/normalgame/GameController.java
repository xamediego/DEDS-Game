package com.mai.scenes.game.normalgame;
...
import com.mai.enums.ButtonType;
import com.mai.exceptions.UnderflowException;
import com.mai.scenes.abstractscene.AbstractController;
import com.mai.scenes.game.Parts.UserInfoBox;
import com.mai.scenes.game.logic.*;
...
public class GameController extends AbstractController implements Initializable {
    ...
    public void endPlayerMove() {
        ...
        if (checkGameConditions(gameData.currentPlayer.getPlayerNumber())) {
            endGame();
        } else {
    ...
    private void endGame(GameData gameData) {
        this.gameMenuController.setGameOverScreen(gameData);
    }
